        ...
        <Box>
            ...
            <Box my={2} mx={3}>
                ...
                <Stack mt={4} direction='row' justifyContent='space-between'>
                    <Button variant="contained" style={{ background: '#f08b32', borderRadius: 20 }} onClick={() => handleDrawer('deleteAction', false, {})}>Cancel</Button>
                    <Button variant="contained" style={{ background: '#f00', borderRadius: 20 }} onClick={handleClick}>Confirm</Button>
                </Stack>
            </Box>
        </Box>
    );
